...
public class WriteTest(SimpleConsoleFixture fixture)
{
    ...
    public async Task InputColorIsSuppressedWhenDisabled()
    {
        ...
        {
            fixture.ClearOutput();
            var task = fixture.ReadLineAsync(new() { AllowEmptyInput = true, InputColor = ConsoleColor.Green });
            fixture.Type("plain");
    ...
    public async Task WriteWhileReadLineIsInProgress()
    {
        ...
        var task = fixture.ReadLineAsync(new() { Prompt = "busy> ", AllowEmptyInput = true });
        fixture.Type("typed");
    ...
    {
        await fixture.WaitForIdle();
        var task = fixture.ReadLineAsync(new() { Prompt = "kept> ", AllowEmptyInput = true });
        fixture.Type("input");
        await SimpleConsoleFixture.Delay(50);
